...
gulp.task('watch', function() {
  ...
  gulp.watch(bases.app + 'pugfiles/*.pug', ['pug-files']);
});
...
gulp.task('pug-files', function(){
  return gulp.src(bases.app + 'pugfiles/*.pug')
  .pipe(pug())
...
gulp.task('default', function(done) {
  runSequence('clean:dist', 'browser-sync', 'pug-files', 'js-app', 'js-libs', 'imagemin', 'minify-html', 'styles', 'themes', 'copy', 'watch', done);
});

gulp.task('build', function(done) {
  runSequence('clean:dist', 'pug-files', 'js-app', 'js-libs', 'imagemin', 'minify-html', 'styles', 'copy', done);
});
